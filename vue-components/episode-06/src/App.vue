...
<template>
  <section class="mx-auto">
    <header>
      <nav
        class="container mx-auto max-w-3xl px-8 pt-2 flex flex-wrap justify-between"
      >
        <div>
          <h1>
            <a href="/11r/">11r</a>
        ...
        <ul
          class="flex flex-wrap sm:w-32 w-full mt-6 md:justify-between justify-evenly"
        >
          <li>
    ...
    <main class="container mx-auto max-w-3xl p-8 grow">
      <div>
        <div class="mb-8 border-dotted border-b pb-8 border-gray-300">
          <h2>
            <a class="block" href="/11r/post/deadbeef-decrementation/"
              >Deadbeef Decrementation</a
            >
          </h2>
          ...
          <a class="tag spirituality" href="/11r/tag/spirituality"
            >spirituality</a
          >
        ...
        <div class="mb-8 border-dotted border-b pb-8 border-gray-300">
          <h2>
            <a class="block" href="/11r/interior-crocodile-alligator/"
        ...
        <div class="mb-8 border-dotted border-b pb-8 border-gray-300">
          <h2>
            <a
              class="block"
              href="/11r/post/why-my-practice-of-thelema-makes-me-better-at-world-of-warcraft/"
              >Why My Practice of Thelema Makes Me Better at World of
              Warcraft</a
            >
          </h2>
        ...
        <div class="mb-8 border-dotted border-b pb-8 border-gray-300">
          <h2>
            <a
              class="block"
              href="/11r/post/shrek-predicted-the-covid-19-pandemic/"
              >Shrek Predicted the COVID-19 Pandemic</a
            >
          </h2>

          <p class="excerpt">Find out how Shrek is disrupting astrology.</p>

          <a class="tag orcas" href="/11r/tag/orcas">orcas</a
          ><a class="tag beer" href="/11r/tag/beer">beer</a>
      ...
      <div class="grid grid-flow-row grid-cols-3 gap-4 mb-2">
        ...
        <a class="tag enchiladas mx-auto" href="/11r/tag/enchiladas"
          >enchiladas</a
        >
        <a class="tag beer mx-auto" href="/11r/tag/beer">beer</a>
        <a class="tag spirituality mx-auto" href="/11r/tag/spirituality"
          >spirituality</a
        >
