...
<template>
  <section class="mx-auto">
    ...
    <div class="flex items-center justify-center h-[600px] font-medium">
          ...
          <div>
            ...
            >
              ...
              <span class="ml-4 text-sm"
                >Destroy ring and defeat dark lord.</span
              >
            </label>
          </div>
        </div>
      ...
      <div
        class="flex flex-grow items-center justify-center bg-gray-900 h-full"
      >
        <!-- Component Start -->
        <div
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <span class="ml-4 text-sm"
                >Eavesdrop on Master Frodo &amp; Gandalf.</span
              >
            </label>
          </div>
          <div>
            ...
            >
              ...
              <span class="ml-4 text-sm"
                >Boil, mash, and stick potatoes in stew.</span
              >
            </label>
          </div>
          <div>
